          ...
          >
            <Box flex={{ base: "auto", md: 2, xl: 2 }} py={10}>
              ...
              <Text fontSize="1.5625rem" lineHeight="2.1875rem">
                ...
                interactive resource that equips New Yorkers with data to
                navigate challenging conversations about housing affordability,
        ...
        >
          ...
          >
            ...
            <Box flex={{ base: "auto", lg: 2 }}>
              ...
              <Text pb="0.5em">
                ...
                race/ethnicity, to allow New Yorkers to learn about
                commonalities and disparities across neighborhoods and
                demographic groups.
              </Text>
              <Text color="black">
                Go to{" "}
          ...
          >
            ...
            <Box flex={{ base: "auto", lg: 2 }}>
              ...
              <Text pb="0.5em">
                The Displacement Risk Map illustrates the level of risk
                residents may face of being unable to stay in their home or
                neighborhood. The map combines data about housing and
                demographics to indicate the level of displacement risk in
                different neighborhoods as compared to each other. It provides
                context for the consideration of proposed projects and supports
                the continuing development of strategies to help enable New
                Yorkers to stay in their homes and neighborhoods. The map
                represents a snapshot of current conditions and does not provide
                sufficient information to predict the effect that future
                changes, such as changes to zoning or housing supply, would have
                on any neighborhood.
              </Text>
              <Text color="black">
                Go to the{" "}
          ...
          >
            <Box flex={{ base: "auto", lg: 2 }}>
              ...
              <Text pb="0.5em">
                ...
                applying for land use changes must produce a Racial Equity
                Report using information pulled from the data tool. This report
                will assist racial equity discussions during the public land use
                ...
                data tool, a narrative statement of how the project relates to
                the City&apos;s goals and strategies to{" "}
                <Link
          ...
          >
            <Box flex={{ base: "auto", lg: 1 }} py={5} px={[10, 0]}>
              ...
              <Text pb="0.5em">
                ...
                directed the DCP and HPD to determine the complete data points
                and specify methodologies for how the data points should be
            ...
            <Box flex={{ base: "auto", lg: 1 }} py={5} px={[10, 0]}>
              ...
              <Text pb="0.5em">
                ...
                reflect decades of wide-ranging thought and research on social
                and racial equity, housing policy, and neighborhood change.
              </Text>
              <Text color="black">
                Open the{" "}
                <Link
            ...
            <Box flex={{ base: "auto", lg: 1 }} py={5} px={[10, 0]}>
              ...
              <Text pb="0.5em">
                ...
                points, sources, and methodologies included in the Data
                Explorer.
              </Text>
              <Text color="black">
                Open the{" "}
