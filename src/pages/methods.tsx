          ...
          <Box flex={{ base: "auto", xl: 2 }}>
            ...
            <Box width={["100%"]} pb="1.5rem">
              ...
              <Text pb="0.5em" lineHeight="1.625rem">
                ...
                complete set of data points and a methodology to combine the
                data points into an index based on research, precedents from
                other cities, and conversations with stakeholders.
              </Text>
            </Box>
            <Box width={["100%"]} pb="1.5rem">
              ...
              <UnorderedList lineHeight="1.625rem">
                ...
                <ListItem>
                  ...
                  for lower-income residents to remain or find new housing in
                  the area. It includes data points related to changes in the
                  housing market and demographic composition of a neighborhood,
                  among others.
                </ListItem>
              </UnorderedList>
            </Box>
            <Box width={["100%"]} pb="1.5rem">
              ...
              <Text pb="1rem">
                ...
                points or categories could be emphasized over others, depending
                on how strongly they contribute to the likelihood of
                residents&apos; ability to stay in their homes. Because research
                suggests that demographic data are a stronger predictor of
                displacement risk than housing conditions or market pressure
                data, DCP and HPD focused on methodologies to combine the data
                while prioritizing population characteristics (e.g. race,
                income, English language proficiency, and rent burden).
              </Text>
              <Text pb="1rem">
                ...
                population vulnerability drives displacement risk and considers
                how it can be exacerbated by market pressure or mitigated by
                housing security.
              </Text>
              <Text pb="1rem">
                See our{" "}
            ...
            <Box width={["100%"]} pb="1rem">
              ...
              <Text pb="1rem">
                ...
                displacement risk map and the categories they are grouped within
                (e.g. population vulnerability, housing conditions, market
                pressure).
              </Text>
            ...
            <Box width={["100%"]} pt="1rem" pb="1rem">
              ...
              <Text pb="0.5em" lineHeight="1.625rem">
                ...
                Use Microdata Area (PUMA) scale, a statistical area defined by
                the US Census. PUMAs in New York City generally approximate
                Community Districts. Displaying the data at the PUMA scale
                allows the tool to report data broken down by race and
                ethnicity. Data in Community Data is also reported at the
            ...
            <Box width={["100%"]} pb="1rem">
              ...
              <Text pb="0.5em" lineHeight="1.625rem">
                ...
                Housing and Vacancy Survey (HVS), meaning the data are based on
                a sample and there is a margin of error (MOE) associated with
                each data estimate. Estimates and associated MOEs vary greatly
                in size, so it helps to examine the size of an MOE in relation
                to its associated estimate to better understand the relative
                reliability using a coefficient of variation (CV). These
                measures of reliability help you gauge the degree to which they
                can trust any given statistic.
              </Text>
              <Text pb="0.5em" lineHeight="1.625rem">
                ...
                or equal to 20%. Data associated with count estimates of zero
                and top-coded median (estimate can be anywhere above the
                displayed value) and bottom-coded median (estimate can be
                anywhere below the displayed value) are also shown in a gray
                font color to alert users that data are either relatively
                unreliable, or of indeterminate reliability. Estimates, and
                associated MOEs, of change over time for a selected area may
                also be shown in a gray font color, indicating that the
                estimates have poor statistical reliability (CVs are greater
                than or equal to 20%).
              </Text>
              <Text pb="1rem" lineHeight="1.625rem">
