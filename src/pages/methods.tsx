          ...
          >
            <Box flex={{ base: "auto", xl: 2 }}>
              ...
              <Text fontSize="1.5625rem" lineHeight="2.1875rem">
                ...
                Development Data Explorer, but directed the NYC Departments of
                City Planning and Housing Preservation and Development to
                determine the complete list of data points and specify
                methodologies for how the data points should be incorporated
                into a displacement risk map. Below, please find descriptions of
        ...
        <Center py={{ base: 10, xl: 20 }} px={{ base: 4, lg: 6 }}>
          ...
          >
            <Box flex={{ base: "auto", xl: 2 }}>
              <Box width={["100%"]} pb="1.5rem">
                ...
                <Text pb="0.5em" lineHeight="1.625rem">
                  Community Data contains demographic, housing, and quality of
                  life data broken out by race and ethnicity (when available) at
                  the neighborhood, borough, and citywide scales. Community Data
                  also shows change over time between 2000 and 2020. See data
                  sources below.
                </Text>
              </Box>
              <Box width={["100%"]} pb="1.5rem">
                ...
                <Text pb="0.5em" lineHeight="1.625rem">
                  ...
                  displacement risk in different neighborhoods as compared to
                  each other. <b>Displacement</b> refers to the involuntary
                  movement of an individual or family from their home or
                  neighborhood, whether as the result of eviction, unaffordable
                  housing costs, or poor-quality housing. There are many factors
                  that may contribute to residents&apos; risk of displacement,
                  though there is no standard methodology for how to measure it.
                  Building on data points listed in Local Law 78 of 2021, DCP
                  and HPD identified a complete set of data points and a
                  methodology to combine the data points into an index based on
                  research, precedents from other cities, and conversations with
                  stakeholders.
                </Text>
              </Box>
              <Box width={["100%"]} pb="1.5rem">
                <Heading size="lg" pb="0.5em" fontSize="1.5625rem">
                  The three major categories of data points in the displacement
                  risk index include:
                </Heading>
                <UnorderedList lineHeight="1.625rem">
                  ...
                  <ListItem>
                    ...
                    whether a household rents or owns, and applicability of
                    various programs or regulations limiting rent increases.{" "}
                  </ListItem>
                  <ListItem>
                    <b>Market Pressure:</b> This category refers to the broader
                    conditions affecting neighborhoods that tend to make it
                    harder for lower-income residents to remain or find new
                    housing in the area. It includes data points related to
                    changes in the housing market and demographic composition of
                    a neighborhood, among others.
                  </ListItem>
                </UnorderedList>
              </Box>
              <Box width={["100%"]} pb="1.5rem">
                ...
                <Text pb="1rem">
                  When incorporating the data into an index, individual data
                  points or categories could be emphasized over others,
                  depending on how strongly they contribute to the likelihood of
                  residents&apos; ability to stay in their homes. Because
                  research suggests that demographic data are a stronger
                  predictor of displacement risk than housing conditions or
                  market pressure data, DCP and HPD focused on methodologies to
                  combine the data while prioritizing population characteristics
                  (e.g. race, income, English language proficiency, and rent
                  burden).
                </Text>
                <Text pb="1rem">
                  Our selected methodology creates an overall risk level based
                  on how neighborhood and housing conditions magnify or reduce
                  population vulnerability. This methodology assumes that
                  population vulnerability drives displacement risk and
                  considers how it can be exacerbated by market pressure or
                  mitigated by housing security.
                </Text>
                <Text pb="1rem">
                  See our{" "}
                  <Link
              ...
              <Box width={["100%"]} pb="1rem">
                ...
                <Text pb="1rem">
                  ...
                  for maps of each of the data points that comprise the
                  displacement risk map and the categories they are grouped
                  within (e.g. population vulnerability, housing conditions,
                  market pressure).
                </Text>
              ...
              <Box width={["100%"]} pt="1rem" pb="1rem">
                <Heading size="lg" pb="0.5em" fontSize="2.125rem">
                  Explanation of the geographic scale used for Equitable
                  Development Data Explorer
                </Heading>
                <Text pb="0.5em" lineHeight="1.625rem">
                  The data that makes up Community Data is displayed at the
                  Public Use Microdata Area (PUMA) scale, a statistical area
                  defined by the US Census. PUMAs in New York City generally
                  approximate Community Districts. Displaying the data at the
                  PUMA scale allows the tool to report data broken down by race
                  and ethnicity. Data in Community Data is also reported at the
                  borough and citywide levels.
                </Text>
                <Text pb="1rem" lineHeight="1.625rem">
                  The Displacement Risk Map, which is not broken down by race
                  and ethnicity, is displayed at a smaller geography,
                  Neighborhood Tabulation Areas (NTA). NTAs are groupings of
                  census tracts that are designed to approximate neighborhoods.
                </Text>
                <Divider borderColor={"#A0AEC0"} pb="1rem" />
              </Box>
              <Box width={["100%"]} pb="1rem">
                ...
                <Text pb="0.5em" lineHeight="1.625rem">
                  The data tool incorporates several data sources that are
                  surveys, such as the American Community Survey (ACS) and the
                  Housing and Vacancy Survey (HVS), meaning the data are based
                  on a sample and there is a margin of error (MOE) associated
                  with each data estimate. Estimates and associated MOEs vary
                  greatly in size, so it helps to examine the size of an MOE in
                  relation to its associated estimate to better understand the
                  relative reliability using a coefficient of variation (CV).
                  These measures of reliability help you gauge the degree to
                  which they can trust any given statistic.
                </Text>
                <Text pb="0.5em" lineHeight="1.625rem">
                  Indicators in the tool may include values in a gray font color
                  which mean that they have poor statistical reliability. For
                  estimates and margins of error with a coefficient of
                  variation, the gray font color is an indication that the CV is
                  greater than or equal to 20%. Data associated with count
                  estimates of zero and top-coded median (estimate can be
                  anywhere above the displayed value) and bottom-coded median
                  (estimate can be anywhere below the displayed value) are also
                  shown in a gray font color to alert users that data are either
                  relatively unreliable, or of indeterminate reliability.
                  Estimates, and associated MOEs, of change over time for a
                  selected area may also be shown in a gray font color,
                  indicating that the estimates have poor statistical
            ...
            <Box flex={{ base: "auto", xl: 1 }}>
              ...
              <Text>
                housing conditions, demographic conditions, public health and
                more
              </Text>
              <Text fontWeight="bold" pt="0.5em" fontSize="1.25rem">
                Permissions
