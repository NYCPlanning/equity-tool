...
const pages = [
  {
    path: "/about",
    title: "About",
    image: `https://${process.env.NEXT_PUBLIC_DOMAIN}/edde-logo-for-social.png`,
  },
  {
    path: "/methods",
  ...
  },
  {
    path: "/map/data",
    title: "Map",
    image: `https://${process.env.NEXT_PUBLIC_DOMAIN}/community-data-landing-page.png`,
  },
  {
    path: "/map/drm",
    title: "Displacement Risk Map",
    image: `https://${process.env.NEXT_PUBLIC_DOMAIN}/drm-landing-page.png`,
  },
  {
    path: "/data",
    title: "Data Tables",
    image: `https://${process.env.NEXT_PUBLIC_DOMAIN}/data-tables.png`,
  },
];
